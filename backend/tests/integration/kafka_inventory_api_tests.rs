...
use mayyam::controllers::kafka::{
    ...
    get_kafka_replica_inventory_pillar_reports, get_kafka_sasl_inventory_pillar_reports,
    get_kafka_tls_inventory_pillar_reports, get_kafka_topic_inventory_pillar_reports,
};
