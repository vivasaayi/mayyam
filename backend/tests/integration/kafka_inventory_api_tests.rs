...
use mayyam::controllers::kafka::{
    ...
    get_kafka_isr_health_inventory_pillar_reports, get_kafka_partition_inventory_pillar_reports,
    get_kafka_replica_inventory_pillar_reports, get_kafka_topic_inventory_pillar_reports,
};
