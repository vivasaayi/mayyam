...
CREATE INDEX IF NOT EXISTS idx_data_sources_resource_type ON data_sources(resource_type);
...
CREATE INDEX IF NOT EXISTS idx_llm_providers_created_at ON llm_providers(created_at);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_prompt_templates_name_version ON prompt_templates(name, version);
...
CREATE INDEX IF NOT EXISTS idx_analytics_executions_resource_id ON analytics_executions(resource_id);
CREATE INDEX IF NOT EXISTS idx_analytics_executions_resource_type ON analytics_executions(resource_type);
CREATE INDEX IF NOT EXISTS idx_analytics_executions_analysis_type ON analytics_executions(analysis_type);
CREATE INDEX IF NOT EXISTS idx_analytics_executions_status ON analytics_executions(status);
CREATE INDEX IF NOT EXISTS idx_analytics_executions_created_at ON analytics_executions(created_at);
...
('00000000-0000-0000-0000-000000000021', 'AWS CloudWatch - DynamoDB', 'CloudWatch metrics for DynamoDB tables', 'metrics', 'DynamoDB', 'CloudWatch', '{"namespace": "AWS/DynamoDB", "region": "us-east-1"}'),
('00000000-0000-0000-0000-000000000022', 'AWS CloudWatch - RDS', 'CloudWatch metrics for RDS instances', 'metrics', 'RDS', 'CloudWatch', '{"namespace": "AWS/RDS", "region": "us-east-1"}'),
('00000000-0000-0000-0000-000000000023', 'AWS CloudWatch - EKS', 'CloudWatch metrics for EKS clusters', 'metrics', 'Kubernetes', 'CloudWatch', '{"namespace": "AWS/EKS", "region": "us-east-1"}')
...
('00000000-0000-0000-0000-000000000031', 'DynamoDB_performance_analysis', 'Analyze DynamoDB table performance metrics', 'DynamoDB', 'analysis',
...
('00000000-0000-0000-0000-000000000032', 'RDS_performance_analysis', 'Analyze RDS instance performance metrics', 'Database', 'analysis',
...
('00000000-0000-0000-0000-000000000033', 'Kubernetes_performance_analysis', 'Analyze Kubernetes cluster performance metrics', 'Kubernetes', 'analysis',
...
'{"resource_id": "string", "time_range": {"start": "datetime", "end": "datetime"}, "metrics": "array"}') ON CONFLICT (name, version) DO NOTHING;
