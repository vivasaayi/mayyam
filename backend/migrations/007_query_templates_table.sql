...
CREATE INDEX IF NOT EXISTS idx_query_templates_connection_type ON query_templates(connection_type);
...
INSERT INTO query_templates (
    ...
    '00000000-0000-0000-0000-000000000011'::uuid, 'Show Tables', 'SHOW TABLES;', 
...
INSERT INTO query_templates (
    ...
    '00000000-0000-0000-0000-000000000012'::uuid, 'Show Process List', 'SHOW PROCESSLIST;', 
...
INSERT INTO query_templates (
    ...
    '00000000-0000-0000-0000-000000000013'::uuid, 'Top Queries by Execution Time', 
    'SELECT 
...
INSERT INTO query_templates (
    ...
    '00000000-0000-0000-0000-000000000014'::uuid, 'List Tables', 
...
INSERT INTO query_templates (
    ...
    '00000000-0000-0000-0000-000000000015'::uuid, 'Database Size', 
...
INSERT INTO query_templates (
    ...
    '00000000-0000-0000-0000-000000000016'::uuid, 'Active Connections', 
