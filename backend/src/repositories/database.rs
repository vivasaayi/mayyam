...
use crate::models::database::{
    self, ActiveModel as DbConnectionActiveModel, Entity as DbConnection,
    Model as DbConnectionModel,
};
...
impl DatabaseRepository {
    ...
    pub async fn find_by_type(
        &self,
        connection_type: &str,
    ) -> Result<Vec<DbConnectionModel>, AppError> {
        let connections = DbConnection::find()
    ...
    pub async fn create(
        &self,
        connection_data: &database::CreateDatabaseConnectionRequest,
        user_id: Uuid,
    ) -> Result<DbConnectionModel, AppError> {
