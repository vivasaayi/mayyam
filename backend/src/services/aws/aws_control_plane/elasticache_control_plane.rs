    ...
    pub async fn sync_clusters(
        ...
        let response = client
            ...
            .map_err(|e| {
                ...
                AppError::ExternalService(format!(
                    "Failed to describe ElastiCache clusters: {}",
                    inner_aws_error
                ))
            })?;
        ...
        for cache_cluster in response.cache_clusters() {
            ...
            let tags_response = client
                ...
                .map_err(|e| {
                    AppError::ExternalService(format!(
                        "Failed to get tags for ElastiCache cluster {}: {}",
                        cluster_id, e
                    ))
                })?;
            ...
            resource_data.insert(
                ...
                json!(cache_cluster.auto_minor_version_upgrade()),
            );
