...
impl LambdaControlPlane {
    ...
    pub async fn sync_functions_with_client(&self, account_id: &str, profile: Option<&str>, region: &str, client: aws_sdk_lambda::Client) -> Result<Vec<aws_resource::Model>, AppError> {
